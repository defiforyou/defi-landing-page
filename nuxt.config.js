...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { property: 'og:image', content: 'https://s3.ap-southeast-1.amazonaws.com/beta-storage-dfy/upload/dbcfcbda89f046ac9df4343a9a1ca1fa1655268032158' },
      { property: 'og:image:type', content: 'image/png' },
      { property: 'og:type', content: 'article' },
      { property: 'og:url', content: 'https://defiforyou.uk' },
      { property: 'twitter:card', content: 'summary' },
      { property: 'twitter:title', content: 'DeFi For You | DeFi For You UK' },
      { property: 'twitter:image', content: 'https://s3.ap-southeast-1.amazonaws.com/beta-storage-dfy/upload/dbcfcbda89f046ac9df4343a9a1ca1fa1655268032158' },
  ...
  plugins: [
    ...
    { src: '~/plugins/dplayer', mode: 'client' },
